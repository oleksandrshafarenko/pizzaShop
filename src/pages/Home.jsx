...
const Home = () => {
    ...
    useEffect(() => {
        ...
        window.scrollTo(0, 0)
    }, [categoriItem, sortItem, selectPage, findPizzaValue])
    ...
    return (
        <>
            <div className="container">
                ...
                {isLoadingPage && <Pagination valuePage={selectPage} onClickSelectPage={(number) => setSelectPage(number)} pageQuantity={pizzaTotalPages}/>}
            </div>
        </>
    )
}
